            ...
            <div class="ac-center box">
                ...
                <div class="ac">
                    ...
                    @if($latest['sale_price']>0)
                        <div class="price">
                            <strike style="color: #761b18;">PHP {{$latest['price']}}</strike>
                            <span style="color: #2d995b">PHP {{$latest['sale_price']}}</span>
                        </div>
                        <a href="{{route('products.productshop')}}" class="btn btn-outline-success">ORDER NOW</a>
                    @else
                        <div class="price">PHP {{$latest['price']}}</div>
                        <a href="{{route('products.productshop')}}" class="btn btn-outline-success">ORDER NOW</a>
                    @endif
                </div>
                @endforeach
            ...
            <div class="ac-center box">
                ...
                <div class="ac">
                    ...
                    @if($product['sale_price']>0)
                        <div class="price">
                            <strike style="color: #761b18;">PHP {{$product['price']}}</strike>
                            <span style="color: #2d995b">PHP {{$product['sale_price']}}</span>
                        </div>
                        <a href="{{route('products.productshop')}}" class="btn btn-outline-success">ORDER NOW</a>
                    @else
